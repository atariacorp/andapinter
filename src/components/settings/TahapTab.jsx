        ...
        <div className="lg:col-span-5 space-y-6 md:space-y-8 animate-slide-up-fade">
          ...
          <div className={glassCard}>
            ...
            <div className="flex items-center gap-4 mb-6 relative z-10">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-[#d7a217]/20 to-transparent border border-[#d7a217]/30 shadow-[inset_0_0_15px_rgba(215,162,23,0.2)] group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                <Layers size={24} style={{ color: colors.gold }} className="drop-shadow-md" />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
              ...
              >
                ...
                <span className="relative z-10 drop-shadow-md">
                  {isProcessing ? 'MENYIMPAN DATA...' : 'TAMBAH TAHAP'}
                </span>
              </button>
            </form>
          </div>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-5 relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-medium mb-5 leading-relaxed" style={{ color: isDarkMode ? colors.tealLight : colors.tealDark, opacity: 0.8 }}>
                    Sistem mendeteksi belum ada master data tahap. Anda dapat menambahkannya satu per satu secara manual atau menghasilkan struktur tahap standar secara otomatis.
                  </p>
                  <button 
                  ...
                  >
                    ...
                    <span className="relative z-10">GENERATE TAHAP DEFAULT</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex items-start gap-3 relative z-10">
              <Layers size={18} className="shrink-0 mt-0.5" style={{ color: colors.gold }} />
              <p className="text-xs md:text-sm font-semibold leading-relaxed tracking-wide">
                Tahapan yang didaftarkan di sini akan muncul sebagai referensi global pada opsi filter dan form verifikasi. <strong style={{ color: isDarkMode ? colors.tealLight : colors.tealDark }}>Instansi (SKPD) tidak memiliki akses untuk membuat atau memilih tahap ini secara mandiri.</strong>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative flex-1 h-full min-h-[500px] rounded-3xl overflow-hidden transition-all duration-700 hover:shadow-[0_20px_40px_rgba(0,0,0,0.1)]"
            ...
            <div className="h-full [&>div]:h-full [&>div]:border-none [&>div]:bg-transparent [&>div]:shadow-none">
              <MasterDataTable
                ...
                onDelete={onDelete}
                emptyMessage="Belum ada data master Tahap yang terdaftar."
